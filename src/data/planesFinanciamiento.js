...
export const planesFinanciamiento = [
  ...
  },
  {
    ...
    calcular: (precioBase) => {
      ...
      const cuotaBs = cuotaMensual; // Se paga en Bs al tipo de cambio del día
      ...
      return {
        ...
        interes: 0,
        desglose: [
          { concepto: '5 Cuotas en USD', monto: cuotasUSD },
  ...
  },
  {
    ...
    calcular: (precioBase) => {
      ...
      const cuotaEspecial = saldoFinanciar * 0.05; // 5% cada una
  ...
  },
  {
    ...
    calcular: (precioBase) => {
      const montoPreEntrega = precioBase * 0.30; // 30% en pre-entrega
      const cuotaPreEntrega = montoPreEntrega / 16;
      const montoPostEntrega = precioBase * 0.70; // 70% post-entrega
  ...
  },
  {
    ...
    desventajas: [],
    requisitos: [],
    formula: 'IVA 16% + IGTF 3% + Placa $440 + Seguro incluido',
    calcular: (precioBase) => {
      const iva = precioBase * COSTOS_ADICIONALES.IVA;
      const igtf = precioBase * COSTOS_ADICIONALES.IGTF;
      const placa = COSTOS_ADICIONALES.PLACA;
      ...
      return {
        ...
        desglose: [
          ...
          { concepto: 'Placa/INTT', monto: placa, nota: 'Costo fijo de emplacamiento' },
          { concepto: 'Seguro', monto: 0, nota: 'Incluido por 1 año' }
        ]
      };
    }
  }
